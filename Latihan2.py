x = int()                                           ## Memperkenalkan variable x sebagai integer, kemudian menimput nilainya
y = 0                                               ## Memperkenalkan variable y dengan nilai 0
while x >= 0:                                       ## Looping While apabila nilai x tidak sama dengan 0
    x = int(input("Masukkan Bilangan: "))           ## Program yang akan di looping
    ...
    if x == 0:                                      ## If kondisi apabila nilai x sama dengan 0
            break                                   ## Fungsi yang menghentikan operasi dibawhnya jika suatu kondisi yang ditentukan
